...
<body id="proyectos">
    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-12">
                <p class="subtitle">Los siguientes son algunos de los trabajos que he realizado:</p>
            </div>
        </div>
        <div class="row">
    ...
    <footer class="container">
        <div class="row mt-5 pb-3">
            ...
            <div class="col-12 col-sm-3 text-sm-start  pt-2 p-sm-0">
                <a href="mailto:gonzalodillman@gmail.com">Gonzalodillman@gmail.com</a>
            </div>
        </div>
    </footer>
    <div class="whatsapp">
        <a href="https://api.whatsapp.com/send?phone=59899927613" title="Whatsapp"><i class="fab fa-whatsapp"></i></a>
    </div>
